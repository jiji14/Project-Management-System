...
<head>
  ...
  <link rel=stylesheet href="${path}/a01_com/gantt/platform.css" type="text/css">
  <link rel=stylesheet href="${path}/a01_com/gantt/libs/jquery/dateField/jquery.dateField.css" type="text/css">




  <link rel=stylesheet href="${path}/a01_com/gantt/gantt.css" type="text/css">
  <link rel=stylesheet href="${path}/a01_com/gantt/ganttPrint.css" type="text/css" media="print">
  ...
  <script src="${path}/a01_com/gantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
  <script src="${path}/a01_com/gantt/libs/jquery/jquery.timers.js"></script>





  <script src="${path}/a01_com/gantt/libs/utilities.js"></script>
  <script src="${path}/a01_com/gantt/libs/forms.js"></script>
  <script src="${path}/a01_com/gantt/libs/date.js"></script>
  <script src="${path}/a01_com/gantt/libs/dialogs.js"></script>
  <script src="${path}/a01_com/gantt/libs/layout.js"></script>
  <script src="${path}/a01_com/gantt/libs/i18nJs.js"></script>
  <script src="${path}/a01_com/gantt/libs/jquery/dateField/jquery.dateField.js"></script>
  <script src="${path}/a01_com/gantt/libs/jquery/JST/jquery.JST.js"></script>

  <script type="text/javascript" src="${path}/a01_com/gantt/libs/jquery/svg/jquery.svg.min.js"></script>
  <script type="text/javascript" src="${path}/a01_com/gantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


  <script src="${path}/a01_com/gantt/ganttUtilities.js"></script>
  <script src="${path}/a01_com/gantt/ganttTask.js"></script>
  <script src="${path}/a01_com/gantt/ganttDrawerSVG.js"></script>
  <script src="${path}/a01_com/gantt/ganttZoom.js"></script>
  <script src="${path}/a01_com/gantt/ganttGridEditor.js"></script>
  <script src="${path}/a01_com/gantt/ganttMaster.js"></script>  
...
/* 			$.ajax({
				type:"post",
				url:"${path}/gantt2.do?method=data",
...
ret= {"tasks":    [
      ...
      {"id": -7, "name": "test on ie", "progress": 0, "description": "", "code": "", "status": "STATUS_SUSPENDED", "depends": "6", "start": 1399327200000, "duration": 3, "end": 1399586399999, "startIsMilestone": false, "endIsMilestone": false, "assigs": [] },
      {"id": -8, "name": "test on chrome", "progress": 0, "description": "", "code": "", "status": "STATUS_SUSPENDED", "depends": "6",  "start": 1399327200000, "duration": 2, "end": 1399499999999, "startIsMilestone": false, "endIsMilestone": false, "assigs": [] } 
...
function loadGanttFromServer() {
  ...
  $.ajax({
		type:"post",
		url:"${path}/task.do?method=data",
		async:false,
		dataType:"json",
		success:function(data){
			var stringData = JSON.stringify(data);
			var changeData = stringData.substring(9,(stringData.length-1))
			var JsonData = JSON.parse(changeData);
			
			console.log(changeData);
			ret = JsonData;
			//alert("data JSON 타입으로 변환되나요?")
			},
			error:function(err){
				console.log(err);
			}
