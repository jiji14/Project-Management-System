	...
	<form:form commandName="project" method="post" >	
		<div class="input-group mb-3">
			...
			<div class="input-group mb-3">
      		...
      		<form:input path="prjadmin" class="form-control" value="${param.prjadmin }" />
      			<div class="input-group-prepend">
      				<span class="input-group-text">카테고리</span>
      			</div>
      		<form:input path="category" class="form-control" value="${param.category }" />
      			<div class="input-group-prepend">
      				<span class="input-group-text">공개범위</span>
      			</div>
      		<form:select path="permission" class="form-control" selected="${param.permission }">
