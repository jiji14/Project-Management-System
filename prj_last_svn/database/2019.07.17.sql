...
INSERT INTO tasks values('tasks'||tasks_seq.nextval,'pro10100','수니업무',0,'백앤드 개발 수정입니다.','STATUS_ACTIVE','',2001010,5,20102101010,0,0,'assigs1',0,'높음',sysdate,'');


INSERT INTO tasks values('tasks'||tasks_seq.nextval,'pro10101','수니업무',0,'백앤드 개발 수정입니다.','STATUS_ACTIVE','',2001010,5,20102101010,0,0,'assigs2',0,'높음',sysdate,'');
INSERT INTO tasks values('tasks'||tasks_seq.nextval,'pro10101','수니업무',0,'백앤드 개발 수정입니다.','STATUS_ACTIVE','',2001010,5,20102101010,0,0,'assigs2',0,'높음',sysdate,'');
INSERT INTO tasks values('tasks'||tasks_seq.nextval,'pro10102','수니업무',0,'백앤드 개발 수정입니다.','STATUS_ACTIVE','',2001010,5,20102101010,0,0,'assigs3',0,'높음',sysdate,'');
