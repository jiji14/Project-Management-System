...
public class A07_TodoService {
	...
	public ArrayList<ToDoList> todoPending(Member member){
		return dao.todoPending(member);
	}
	...
	public ArrayList<ToDoList> hiddenPending(Member member){
		return dao.hiddenPending(member);
	}
