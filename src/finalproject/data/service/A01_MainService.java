...
public class A01_MainService {
	...
	/* 알람 */
	public ArrayList<ToDoList> alarmList(String memno){
		return dao.alarmList(memno);
	}
	
	/* 알람 전체 읽음표시 */
	public void checkAllAlarm(String memno) {
		dao.checkAllAlarm(memno);
	}
	
	public void checkEachAlarm(String taskid) {
		System.out.println("알람 서비스단");
		dao.checkEachAlarm(taskid);
	}
}
