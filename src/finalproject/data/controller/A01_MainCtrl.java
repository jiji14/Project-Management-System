...
public class A01_MainCtrl {
	...
	@RequestMapping(params="method=alram")
	public String alarmList(HttpSession session, Model d) {
		...
		//알람 내역
		String memno = mem.getMemno();
		ArrayList<ToDoList> todo = service.alarmList(memno);
		for(ToDoList t: todo) {
			System.out.println(t.getName());
		}
		d.addAttribute("todolist", todo);
		
		return "pageJsonReport";
	}
	
	@RequestMapping(params="method=checkAllAlarm")
	public String checkAllAlarm(HttpSession session, Model d) {
		...
		//알람 내역
		String memno = mem.getMemno();
		System.out.println("알람체크"+memno);
		service.checkAllAlarm(memno);
		d.addAttribute("isSucc", "ok");
		
		return "pageJsonReport";
	}
	
	@RequestMapping(params="method=checkEachAlarm")
	public String checkEachAlarm(@RequestParam("taskid") String taskid, HttpSession session, Model d) {
		...
		System.out.println("알람:"+taskid);
		//알람 내역
		System.out.println("전체 삭제전");
		String isSucc = "fail";
		d.addAttribute("isSucc", isSucc);
		service.checkEachAlarm(taskid);
		isSucc = "ok";
