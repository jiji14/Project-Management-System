...
!function($) {
    ...
    FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
        ...
        FlotChart.prototype.init = function() {
          //plot graph data
          var uploads = [[0, 9], [1, 8], [2, 5], [3, 8], [4, 5], [5, 14], [6, 10],[7, 9], [8, 8], [9, 5], [10, 8]];
          var downloads = [[0, 5], [1, 12], [2,4], [3, 3], [4, 12], [5, 11], [6, 14],[7, 5], [8, 12], [9,4], [10, 3]];
          var plabels = ["Visits", "Pages/Visit"];
          var pcolors = ['#dcdcdc', '#34c73b'];
          ...
          var datas = [20,30, 15];
          var colors = ['#34c73b', '#3960d1', '#dcdcdc'];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#3960d1']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#fc5d93', '#34c73b', '#3960d1',"#dcdcdc","#3fb7ee"];
