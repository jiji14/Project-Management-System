				...
				<div class="container-fluid" id="container-fluid">
					...
					<div class="listBox">		
						<div class="workcontent">
							...
							<c:forEach var="pend" items="${todoPending}" varStatus="sts">
								<div class="workCard" >
									<span>${sts.count}. ${pend.name}</span>
									<span>${pend.dateEnd} 마감</span>
									<div class="hideBox">
										<label class="detailLabel" onclick="detailFunction('${pend.taskid}')">
											<i class="ion  ion ion-ios-redo icons"></i>										
											Detail
										</label>
										<label class="hideLabel" id="${pend.taskid}">
							...
							<div class="addBox">
								<label class="addLabel" id="pending">
