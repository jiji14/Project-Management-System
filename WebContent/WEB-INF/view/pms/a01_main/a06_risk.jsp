				...
				<div class="container-fluid"> 
					...
					<div class="content_container">
						...
						<div class="portlet"><!-- /primary heading -->
		                   	<div class="portlet-heading">
		                        ...
		                        <h5 class="portlet-widgets">
	                            	** 아래는 위험도/발생가능성/상태/등록일 기준에 따라 분류해 놓은 개별적인 차트입니다.
	                            </h5>
					...
					<div id="portlet3" class="panel-collapse collapse show">
					    <div class="portlet-body" id="chart_main">
					    	<h5 id="risk_h5" class="portlet-title chartTitle">위험도</h5>
					        <canvas id="pie" data-type="Pie" height="250" width="250" ></canvas>                               
							<div class="infoline">
								<c:forEach var="riskdeg" items="${riskdegree}" varStatus="sts">
									<div class="span${sts.count}" ></div><span>${riskdeg.riskdegree} </span>
								</c:forEach>    
							</div>
						</div>
						...
						<div class="chart_text">
							<div class="bar_top">
								<h5 class="portlet-title chartTitle">발생가능성</h5>
								<span></span>
							</div>
						...
						<div class="chart_text">
							<div class="bar_top">
								<h5 class="portlet-title chartTitle">상태</h5>
								<span></span>
							</div>
							<div class="bar_content">
						...
						<div class="chart_text">
							<div class="bar_top">
								<h5 class="portlet-title chartTitle">등록일</h5>
								<span></span>
							</div>
