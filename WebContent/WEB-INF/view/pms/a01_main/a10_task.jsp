...
function loadGanttFromServer() {
  ...
  $.ajax({
		...
		success:function(data){
			...
			var changeData = stringData.substring(9,stringData.length-20);
			console.log("change : "+changeData);
			console.log(typeof(changeData));
...
function saveGanttOnServer() {
  ...
  var prj = ge.saveProject();  //saveProject 가 json을 반환함
  ...
  $.ajax({
    ...
    type:"POST",
	url:"${path}/task.do?method=save",
    success: function(response) {
    	//alert("여기까지 나오나?");
    	if(response.isSave == "no"){
...
function newProject(){
	if(confirm("프로젝트의 업무를 모두 삭제하시겠습니까?")){
		clearGantt();
		alert("삭제되었습니다.");
	}
}
...
<div class="__template__" type="GANTBUTTONS"><!--
  <div class="ganttButtonBar noprint">
    <div class="buttons">
      <a href="https://gantt.twproject.com/"><img src="${path}/a01_com/res/twGanttLogo.png" alt="Twproject" align="absmiddle" style="max-width: 136px; padding-right: 15px"></a>
...
<div class="__template__" type="TASKROW"><!--
  <tr id="tid_(#=obj.id#)" taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    ...
    <td class="gdfCell"><input type="text" name="code" value="" placeholder="code/short name"></td>
